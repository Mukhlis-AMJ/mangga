...
<div>
    ...
    <flux:table.rows>
        ...
        <flux:table.row>
            ...
            <flux:table.cell><flux:badge color="red" size="sm" inset="top bottom">Romance</flux:badge></flux:table.cell>
        </flux:table.row>
        ...
        <flux:table.row>
            ...
            <flux:table.cell variant="strong">$31.00</flux:table.cell>
            <flux:table.cell><flux:badge color="green" size="sm" inset="top bottom">Comedy</flux:badge></flux:table.cell>
        </flux:table.row>
    </flux:table.rows>
</flux:table>
